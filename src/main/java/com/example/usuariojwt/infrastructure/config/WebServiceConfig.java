package com.example.usuariojwt.infrastructure.config;
...
import com.example.usuariojwt.infrastructure.webservice.EmpleadoEndpoint;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema empleadoSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://www.example.com/empleado-ws");
    ...
    @Bean
    public EmpleadoEndpoint empleadoEndpoint() {
        return new EmpleadoEndpoint(employeeRepository);
    }
}
